...
<!--
		<tr>
			<td align="center">
			<input type="button" value="合計" onclick="">
			</td>
			<td align="center">
			總計<input type="text" name="toltal_" size="10">
			院系所<input type="text" name="t_depart" size="6">
			職涯<input type="text" name="t_career" size="6">
			</td>
		</tr>
-->
	</table>
		...
		送出後請列印紙本送至職涯發展中心<br>
		若無安裝印表機，亦可列印成pdf檔，再自行列印成紙本喔!<br>
...
<script>
	...
	/*
					function total(){
						var tot = parseInt(document.getElementById("Grade_01").value)
						 + parseInt(document.getElementById("Grade_02").value)
						  + parseInt(document.getElementById("Grade_03").value)
						   + parseInt(document.getElementById("Grade_04").value)
						    + parseInt(document.getElementById("Grade_n_master").value)
						     + parseInt(document.getElementById("Grade_master").value)
						  	  + parseInt(document.getElementById("Grade_n_doctor").value)
						  	   + parseInt(document.getElementById("Grade_doctor").value);
						document.getElementById("predict_person").value = tot;
					}*/
